...
namespace VSIXMarkGrammlatorLines {
   ...
   internal class GrammlatorClassifierProvider: IClassifierProvider {
...
#pragma warning restore 649
      ...
      public IClassifier GetClassifier(ITextBuffer buffer)
         {
         return buffer.Properties.GetOrCreateSingletonProperty<GrammlatorClassifier>(creator: () => new GrammlatorClassifier(this.classificationRegistry));
         }
